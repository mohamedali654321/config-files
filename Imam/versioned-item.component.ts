...
import { ViewerSwitcherService } from 'src/app/shared/media-viewer-switcher/viewerSwitcherService/viewer-switcher-service.service';
...
export class VersionedItemComponent extends ItemComponent {
  ...
  constructor(
    ...
    super(routeService,store,viewerSwitcher); //mohamed-edit
  }
