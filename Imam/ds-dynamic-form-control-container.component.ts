...
export function dsDynamicFormControlMapFn(model: DynamicFormControlModel): Type<DynamicFormControl> | null {
  switch (model.type) {
    ...
    case DYNAMIC_FORM_CONTROL_TYPE_INPUT:
      return  model.id === 'dc_relation_college' ? DsDynamicOneboxComponent : DynamicNGBootstrapInputComponent;
...
export class DsDynamicFormControlContainerComponent extends DynamicFormControlContainerComponent implements OnInit, OnChanges, OnDestroy, AfterViewInit {
  ...
  openLookup() {
    ...
    console.log(this.model.repeatable,this.listId,this.model.relationship,this.model.metadataFields,this.item,this.collection,this.model.submissionId);
  }
