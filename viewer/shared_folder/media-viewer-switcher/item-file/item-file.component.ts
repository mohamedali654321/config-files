  ...
  getIconByFileFormat() {
    switch (true) {
      ...
      case this.fileFormat === 'application/pdf':
        return '../../../assets/images/files-icons/pdf.png';
      case (this.fileFormat ===
        'application/vnd.openxmlformats-officedocument.presentationml.presentation'
        || this.fileFormat === 'application/vnd.ms-powerpoint'):
        return '../../../assets/images/files-icons/ppt-logo.png';
      case this.fileFormat ===
        'application/vnd.openxmlformats-officedocument.wordprocessingml.document'
        || this.fileFormat === 'application/msword':
        return '../../../assets/images/files-icons/word-logo.png';
      case this.fileFormat.startsWith('video'):
        return '../../../assets/images/files-icons/video-img.png';
      case (this.fileFormat ===
        'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'
        || this.fileFormat === 'application/vnd.ms-excel'):
        return '../../../assets/images/files-icons/excel.png';
      default:
